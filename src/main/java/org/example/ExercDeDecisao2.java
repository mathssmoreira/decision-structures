...
/*
        ...
        caso a meta seja alcançada. Crie um programa que receba 3 parâmetros.
        ...
        (não precisa fazer cálculo de média salarial, já que estamos trabalhando
        com um algoritmo fictício - na hora de informar esse parâmetro, invente um valor qualquer
...
public class ExercDeDecisao2 {
    public static void main (String[] args) {
        Scanner scanner = new Scanner(System.in);

        Double metaFaturamento2022 = 100000.0;
        Double faturamentoAlcancado2022 = 80000.0;
